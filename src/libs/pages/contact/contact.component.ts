...
export class ContactComponent implements OnInit {
  ...
  constructor(private contactFacade: ContactFacade, private router: Router, private detectorDevice: DeviceDetectorService) { }
  ...
  deleteContact(id: string) {
    this.contactFacade.delete(id).subscribe();
  }
